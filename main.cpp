...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "XVIIcoin-seeder\n"
...
static const string mainnet_seeds[] = {"dnsseed1.xviicoin.info", "dnsseed2.xviicoin.info", "dnsseed3.xviicoin.info", ""};
static const string testnet_seeds[] = {"testseed1.xviicoin.info", "testseed2.xviicoin.info", "testseed3.xviicoin.info", ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("kjy2eqzk4zwi5zd3.onion", 6917), true);
  }
  do {
